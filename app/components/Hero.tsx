...
function Hero() {
    return (
        <div className='relative min-h-[100vh] bg-red-500 bg-opacity-90'>
            <Scroll />
            <Image src={heroBg} fill alt='' objectFit='cover' objectPosition='center' className='-z-10 '></Image>

            <div className='z-30 absolute bg-opacity-80 bg-orange-100 left-0 py-4 top-0 bottom-0 right-1/4 flex justify-center items-center flex-col gap-10 pb-6'>
                ...
                <div className='flex flex-col gap-10 w-full md:w-2/3 ml-6 md:ml-0 md:mt-0 mt-10 justify-center md:mr-32'>
                    ...
                    <Button text='Poruči.' color='bg-red-500' addClass=' text-orange-100  ml-5 hover:scale-[105%] duration-200' />
