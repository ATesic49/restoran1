...
function Scroll() {
    ...
    const isZero = scrollY.get() === 0
    return (
        <motion.div
            initial={{ opacity: 0, x: '-50%' }}
            animate={isZero ? { opacity: 1, x: '-50%', transition: { repeat: Infinity, duration: 3, delay: .5, ease: 'easeInOut', repeatType: 'reverse' } } : { opacity: 0, x: '-50%' }}
        ...
        >
            <h3 className='text-white text-2xl md:text-4xl drop-shadow-lg '>Scroll Down
