...
function Timeline({ nasaSlika, godina, naslov, opis }: { nasaSlika: StaticImageData, godina: string, naslov: string, opis: string }) {
    ...
    return (
        <motion.div
            ...
            <div className='flex w-full flex-col gap-2 md:gap-5  md:py-20 justify-center '>
                <h3 className=' text-red-400 text-xl font-bold md:text-2xl  '>{naslov}</h3>
                <p className='text-neutral-400 md:text-base text-sm font-extralight'>{opis}</p>
            </div>
